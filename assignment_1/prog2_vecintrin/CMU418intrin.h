...
__cmu418_mask _cmu418_init_ones(int first = VECTOR_WIDTH); //maybe helpful
...
int _cmu418_cntbits(__cmu418_mask &maska); //maybe useful
...
void _cmu418_hadd_float(__cmu418_vec_float &vecResult, __cmu418_vec_float &vec); //maybe useful
...
void _cmu418_interleave_float(__cmu418_vec_float &vecResult, __cmu418_vec_float &vec); //maybe useful
